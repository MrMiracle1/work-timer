...
|--------|----------|----------|--------|------|
| 1.4.1 | 2025-12-12 | - 修复高亮功能显示问题<br>- 修复AI问书功能<br>- 优化阅读界面布局和样式<br>- 增加AI助手浮动按钮<br>- 采用下划线风格高亮 | 开发团队 | 读书模块优化版本 |
...
#### 问题修复
1. **高亮功能修复**
   - 修复高亮文本替换逻辑，避免破坏HTML结构
   - 优化高亮应用算法，防止重复高亮
   - 增加正则表达式转义方法
   - 高亮现在可以正常显示在阅读内容中

2. **AI问书功能修复**
   - 在reader/index.html中增加ai-module.js引用
   - AI问答现在可以正常调用
   - 支持文本选中后右键点击“问AI”
